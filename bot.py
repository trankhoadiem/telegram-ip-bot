...
async def notify_admin(update, context):
    ...
    msg_text = update.message.text if update.message.text else "(không phải text)"
    # Gửi admin
...
def main():
    ...
    # Bắt mọi tin nhắn text không phải lệnh
